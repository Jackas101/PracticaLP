        ...
        <%
                ...
                while (rs.next()) {  
                    ...
                    <tr>
                        ...
                        <td><a href="DatosSugerencias.jsp?f_accion=E&f_idarea=<%out.print(ide);%>"><span class="icon-bin"></span></a></td>
                        <td><a href="DatosSugerencias.jsp?f_accion=M1&f_idarea=<%out.print(ide);%>"><span class="icon-loop"></span></a></td>
