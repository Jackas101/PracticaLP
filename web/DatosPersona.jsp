        ...
        <%
                ...
                while (rs.next()) {  
                    ...
                    <tr>
                        ...
                        <td><a href="DatosPersona.jsp?f_accion=E&f_idpersona=<%out.print(ide);%>"><span class="icon-bin"></span></a></td>
                        <td><a href="DatosPersona.jsp?f_accion=M1&f_idpersona=<%out.print(ide);%>"><span class="icon-loop"></span></a></td>
